...
"""
This is a Python class thta will act as an interface for the first phase
...
class HBNBCommand(cmd.Cmd):
    """
    This is a class modelling the interface (CLI) for AirBnB Clone project.
    """
    ...
    def do_quit(self, arg: any) -> None:
        """Issues a quit command to the CLI by returnung True"""
        return True
    ...
    def do_create(self, args) -> None:
        """Public instance method that creates new instances of a class, save
    ...
    def help_show(self) -> None:
        ...
        print("repreentation of an instance based on class name", end=" ")
    ...
    def do_destroy(self, args) -> None:
        ...
        based on the instance id and classmate specified"""
        if len(args) == 0:
            print("** class name missing **")
            return
        arg_num = args.split(" ")
